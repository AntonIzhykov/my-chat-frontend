...
class RoomList extends Component {
  ...
  render() {
    const { chat: { currentUser, chatRooms } } = this.props;
    return (
      <div className='room-list'>
        <div className='d-flex align-items-center'>
          ...
          <div className='d-flex flex-column w-25 text-center ml-2'>
            <h5>or</h5>
            <input type="text" name="RoomName" id="RoomName" ref={element => {this.inputRoomName = element}}/>
            ...
            chatRooms.map(room => {
              return(
                <div className='room' key={room._id}>
                  ...
                  {room.roomCreator._id === currentUser._id &&
